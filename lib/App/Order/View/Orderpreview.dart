...
if (widget.quotation.items.isNotEmpty && widget.quotation.items.first.image.isNotEmpty) {
...
style: TextStyle(
fontSize: 14,
color: date != null ? const Color(0xFF302E2E) : Colors.grey[600],
fontWeight: FontWeight.w500,
),
),
],
...
child: Column(
children: [
_buildSummaryRow("Total:", "#${grandTotal.toStringAsFixed(0)}", isBold: true),
const SizedBox(height: 16),
Column(
crossAxisAlignment: CrossAxisAlignment.start,
children: [
...
borderRadius: BorderRadius.circular(8),
borderSide: const BorderSide(color: Color(0xFFA16438), width: 2),
),
...
notes: "Order created from quotation ${widget.quotation.quotationNumber}",
