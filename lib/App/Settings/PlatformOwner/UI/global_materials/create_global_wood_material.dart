...
class CreateGlobalWoodMaterialPage extends StatefulWidget {
  const CreateGlobalWoodMaterialPage({super.key});

  @override
  State<CreateGlobalWoodMaterialPage> createState() =>
      _CreateGlobalWoodMaterialPageState();
}

class _CreateGlobalWoodMaterialPageState
    extends State<CreateGlobalWoodMaterialPage> {
  ...
  void _updateTypePrice(int index, String value) {
    setState(() {
      woodTypes[index] = woodTypes[index].copyWith(
        ...
        child: ListView(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.forest, color: Color(0xFF8B4513)),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Column(
            children: woodTypes.asMap().entries.map((entry) {
...
class WoodType {
  ...
  WoodType copyWith({double? pricePerSqm}) {
    return WoodType(name: name, pricePerSqm: pricePerSqm);
  }
}
